...
<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><?php echo "<br/><br/>Date <h2>".$_POST['date']."</h2></br><br/><br/>";?><?php echo "Name <h1>".$_POST['cmbStudent']."</h1></br>";?>
	 </span></td>
</tr>
</table>
...
<span style="color:#000000;font-family:Arial;font-size:15px;"><strong>Description</strong></span>
</div>
</td>
<td class="cell2"><div id="wb_Text4">
<span style="color:#000000;font-family:Arial;font-size:16px;"><strong>Amount</strong></span>
</div>
</td>
</tr>
<tr>
<td class="cell3"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><br><br>1 </span></td>
<td class="cell4"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><?php echo "<br><br><h3>".$_POST['course_id']."</h3></br>";?> </span></td>
<td class="cell5"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"> <?php echo "<br><br><h3>".$_POST['amount']."</h3></br>";?></span></td>
</tr>
</table>
<table style="position:absolute;left:0px;top:852px;width:690px;height:128px;z-index:11;" id="Table4">
<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><br><h3>Total </h3></span></td>
</tr>
</table>
<table style="position:absolute;left:689px;top:850px;width:660px;height:130px;z-index:12;" id="Table5">
<tr>
<td class="cell0"><span style="color:#000000;font-family:Arial;font-size:13px;line-height:16px;"><?php echo "<br><h3>".$_POST['amount']."</h3></br>";?> </span></td>
</tr>
