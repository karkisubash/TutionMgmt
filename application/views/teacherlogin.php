...
<form name="LOGIN_FORM" method="post" action="<?php echo base_url('teacherActivity/teacher_login')?>">
<span style="color:#000000;font-family:Arial;font-size:53px;"><strong>TEACHER LOGIN</strong></span><br/><br/>
USERNAME:<br/>
