...
<head>
<meta charset="utf-8">
<title>Add Course to class</title>
...
<article>
				<div class="transbox">
					<h1> ADD COURSE CLASS</h1>
					<font color="#77F013" size="+2" face="arial black">
						<form name="admissionform" action="<?php echo base_url();?>mainControl/classAdd" method="post">
							Course:
							...
							Start Time:
							<input type="time" name="start" placeholder="Enter Start Time"/><br/>
							End Time:
							<input type="time" name="end" placeholder="Enter End Time"/><br/>
