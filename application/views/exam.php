...
<form method="post" action="<?php echo base_url('mainControl/saveExam')?>">
<label for="" id="Label1" style="position:absolute;left:0px;top:130px;width:364px;height:73px;line-height:73px;z-index:2;">Marks Obtained</label>
...
<select name ="course" onchange="fetch_select(this.value);" style="position:absolute;left:214px;top:310px;width:195px;height:58px;z-index:6;">
...
<br/>
<label for="" id="Label3" style="position:absolute;left:0px;top:400px;width:186px;height:54px;line-height:54px;z-index:5;">Marks Obtained</label>
<input type="text" name="marks" id="Editbox1" style="position:absolute;left:214px;top:400px;width:195px;height:58px;z-index:6;">
<br/>
