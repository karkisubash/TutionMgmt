...
<link href="<?php echo base_url('assets/eventUpdate.css')?>" rel="stylesheet">
</head>
<body>
...
<form method="post" action="<?php echo base_url('mainControl/eventUpdate')?>" name="eventUpdateForm">
<input type="text" id="Editbox1" style="position:absolute;left:63px;top:139px;width:835px;height:248px;line-height:248px;z-index:4;" name="txtEvent" value="" spellcheck="false">
<input type="submit" id="Button1" name="Update" value="UPDATE EVENTS" style="position:absolute;left:752px;top:409px;width:147px;height:46px;z-index:5;">
</form>
<div id="PageFooter1" style="position:absolute;overflow:hidden;text-align:left;left:0px;top:806px;width:100%;height:102px;z-index:6;">
