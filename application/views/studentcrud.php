...
<link href="<?php echo base_url();?>assets/studentcrud.css" media="screen" rel="stylesheet" type="text/css"/>
</head>
<body>
...
<li><a href="#" target="_self">STUDENTS</a>
</li>
<li><a href="#" target="_self">TEACHERS</a>
</li>
<li><a href="#" target="_self">ACCOUNT</a>
</li>
<li><a href="#" target="_self">COURSES</a>
</li>
...
<input type="submit" id="Button1" name="update" value="UPDATE" style="position:absolute;left:376px;top:200px;width:170px;height:45px;z-index:4;">
<input type="submit" id="Button2" name="delete" value="DELETE" style="position:absolute;left:376px;top:292px;width:170px;height:45px;z-index:5;">
<input type="submit" id="Button4" name="view" value="VIEW" style="position:absolute;left:376px;top:375px;width:170px;height:45px;z-index:6;">
<input type="submit" id="Button7" name="add" value="ADD" style="position:absolute;left:376px;top:469px;width:170px;height:45px;z-index:7;">
<div id="PageFooter1" style="position:absolute;overflow:hidden;text-align:left;left:0px;top:558px;width:100%;height:102px;z-index:8;">
