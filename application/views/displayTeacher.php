...
<a href="<?php echo base_url('direct/teacherdashboard')?>"><img src="<?php echo base_url('assets/images/img0019.png')?>" id="MergedObject10" alt="" title="" style="border-width:0;position:absolute;left:695px;top:409px;width:170px;height:45px;z-index:5"></a>
</div>
</div>
