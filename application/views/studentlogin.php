...
<form name="Student_LOGIN_FORM" method="post" action="<?php echo base_url('studentFunctions/student_login')?>">
<span style="color:#000000;font-family:Arial;font-size:53px;"><strong>STUDENT LOGIN</strong></span><br/><br/>
USERNAME:<br/>
...
<!-- <form name="LOGIN_FORM" method="post" action="<?php echo base_url('studentFunction/student_login')?>" enctype="text/plain" id="Form1">
